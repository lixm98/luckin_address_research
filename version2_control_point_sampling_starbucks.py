...
sbux_df, sbux_xy = load_xy("xiamen_starbucks_poi_wgs84.csv")     # 94 homes, distance from pool
...
luckin_df, luckin_xy = load_xy("xiamen_luckin_poi_wgs84.csv")
_, office_xy = load_xy("xiamen_office_wgs84.csv")
_, resid_xy  = load_xy("xiamen_residential_wgs84.csv")
_, mall_xy   = load_xy("xiamen_mall_wgs84.csv")
_, mstat_xy  = load_xy("xiamen_metro_stations_wgs84.csv")
_, mexit_xy  = load_xy("xiamen_metro_exits_wgs84.csv")
...
samp.to_csv("task3_starbucks_features_excl50_seed42.csv", index=False, encoding="utf-8-sig")
print(f"✓ saved task3_starbucks_features_excl50_seed42.csv ({len(samp)}rows = "
