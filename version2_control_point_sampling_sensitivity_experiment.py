...
# ============ CONFIG ============
SAMPLING_AREA_FILE = "sampling_area_final.geojson"
LUCKIN_FILE        = "xiamen_luckin_poi_wgs84.csv"
STARBUCKS_FILE     = "xiamen_starbucks_poi_wgs84.csv"
OFFICE_FILE        = "xiamen_office_wgs84.csv"
RESIDENTIAL_FILE   = "xiamen_residential_wgs84.csv"
MALL_FILE          = "xiamen_mall_wgs84.csv"
METRO_STATION_FILE = "xiamen_metro_stations_wgs84.csv"
METRO_EXIT_FILE    = "xiamen_metro_exits_wgs84.csv"
...
for excl in EXCL_GRID:
    for seed in SEED_GRID:
        ...
        feat.to_csv(f"task1_features_excl{excl}_seed{seed}.csv",
...
summary.to_csv("task1_sensitivity_summary.csv", index=False, encoding="utf-8-sig")
print("\n✓ saved task1_sensitivity_summary.csv")
