...
controls_df.to_csv("controls.csv", index=False, encoding="utf-8-sig")
...
samples.to_csv("samples.csv", index=False, encoding="utf-8-sig")
...
ax.set_aspect('equal')
plt.tight_layout()
plt.savefig("controls_check.png", dpi=150, bbox_inches='tight')
plt.close()
print(f"✓ Check image saved to controls_check.png")
