...
# Luckin sample
features_lk = pd.read_csv("features.csv")
...
# Starbucks sample
features_sb = pd.read_csv("starbucks_features.csv")
...
# LISA results
lisa = pd.read_csv("moran_lisa_results.csv")
...
# GWLR coefficient
gwlr = pd.read_csv("gwlr_local_coefficients.csv")
...
plt.tight_layout()
plt.savefig("fig01_study_area.png", dpi=SAVE_DPI, bbox_inches='tight')
plt.close()
print("  ✓ fig01_study_area.png")
...
plt.tight_layout()
plt.savefig("fig03_sampling_design.png", dpi=SAVE_DPI, bbox_inches='tight')
plt.close()
print("  ✓ fig03_sampling_design.png")
...
plt.tight_layout()
plt.savefig("fig04_bivariate_distributions.png", dpi=SAVE_DPI, bbox_inches='tight')
plt.close()
print("  ✓ fig04_bivariate_distributions.png")
...
plt.tight_layout()
plt.savefig("fig06_lisa_cluster_map.png", dpi=SAVE_DPI, bbox_inches='tight')
plt.close()
print("  ✓ fig06_lisa_cluster_map.png")
...
plt.suptitle("GWLR Local Coefficient Maps (bandwidth K=400)\n"
             ...
             fontsize=12, fontweight='bold', y=1.00)
plt.tight_layout()
plt.savefig("fig07_gwlr_coefficient_maps.png", dpi=SAVE_DPI, bbox_inches='tight')
plt.close()
print("  ✓ fig07_gwlr_coefficient_maps.png")
...
gwlr_local = pd.read_csv("gwlr_local_coefficients.csv")
...
plt.tight_layout()
plt.savefig("fig11_roc_comparison.png", dpi=SAVE_DPI, bbox_inches='tight')
plt.close()
print(f"  ✓ fig11_roc_comparison.png  (Logistic={logit_auc:.3f}, GWLR={gwlr_auc:.3f}, XGBoost-CV={xgb_auc:.3f})")
...
plt.tight_layout()
plt.savefig("fig13_luckin_vs_starbucks_spatial.png", dpi=SAVE_DPI, bbox_inches='tight')
plt.close()
print("  ✓ fig13_luckin_vs_starbucks_spatial.png")
