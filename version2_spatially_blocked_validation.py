...
pool_xy = to_utm(*pd.read_csv("xiamen_luckin_poi_wgs84.csv")[['lon_wgs84','lat_wgs84']].values.T)  # 311 homes
...
res.to_csv("task2_blocked_cv_results.csv", index=False, encoding="utf-8-sig")
print("\n=== New Table 4.7: blocked CV AUC (mean ± sd, 5 folds) ===")
print(res.groupby(['model','version'])['auc'].agg(['mean','std']).round(4))
print("\nPer-fold details saved to task2_blocked_cv_results.csv")