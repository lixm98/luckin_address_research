...
siming = gpd.read_file("geojson/Siming_district.geojson").to_crs("EPSG:4326")
huli   = gpd.read_file("geojson/Huli_district.geojson").to_crs("EPSG:4326")
...
airport = gpd.read_file("geojson/xiamen_airport.geojson").to_crs("EPSG:4326")
...
sampling_gdf.to_file("geojson/sampling_area.geojson", driver="GeoJSON")
...
ax.set_aspect('equal')
plt.tight_layout()
plt.savefig("png/sampling_area_check.png", dpi=150, bbox_inches='tight')
plt.close()
print(f"✓ Step 6: The check image has been saved to png/sampling_area_check.png")
