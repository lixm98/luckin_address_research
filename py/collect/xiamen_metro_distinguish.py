...
df = pd.read_csv("csv/xiamen_metro.csv")
...
# keep
stations.to_csv("csv/xiamen_metro_stations.csv", index=False, encoding='utf-8-sig')
exits.to_csv("csv/xiamen_metro_exits.csv",       index=False, encoding='utf-8-sig')

print("\n✅ Files saved:")
print("   csv/xiamen_metro_stations.csv  →  45 sites for count features")
print("   csv/xiamen_metro_exits.csv     →  ~196 entrances and exits, used for distance features")