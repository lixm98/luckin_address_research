...
ax.grid(alpha=0.3)
plt.tight_layout()
plt.savefig("png/roc_curve.png", dpi=150, bbox_inches='tight')
plt.close()
print(f"\n✓ ROC Curve saved to png/roc_curve.png")
...
odds_table.to_csv("csv/logit_coefficients.csv", encoding='utf-8-sig')
print(f"✓ Coefficient table saved to csv/logit_coefficients.csv")