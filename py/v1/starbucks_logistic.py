...
sb_all = pd.read_csv("csv/xiamen_starbucks_poi_wgs84.csv")
...
features_sb.to_csv("csv/starbucks_features.csv", index=False, encoding="utf-8-sig")
print(f"✓ Features saved to csv/starbucks_features.csv ({len(features_sb)} rows)")
...
sb_table.to_csv("csv/starbucks_logit_coefficients.csv", encoding='utf-8-sig')
print(f"\n✓ Features saved to csv/starbucks_logit_coefficients.csv")
...
summary.to_csv("csv/starbucks_model_summary.csv", index=False, encoding='utf-8-sig')
...
print(f"✓ Features saved to csv/starbucks_model_summary.csv")