...
df_coef.to_csv("csv/gwlr_local_coefficients.csv", index=False, encoding='utf-8-sig')
print(f"\n✓ Local coefficients saved to csv/gwlr_local_coefficients.csv")
...
plt.tight_layout()
plt.savefig("png/gwlr_coefficient_maps.png", dpi=150, bbox_inches='tight')
plt.close()
print(f"✓ Coefficient maps saved to png/gwlr_coefficient_maps.png")
...
ax.grid(alpha=0.3)
plt.tight_layout()
plt.savefig("png/roc_logistic_vs_gwlr.png", dpi=150, bbox_inches='tight')
plt.close()
print(f"✓ ROC comparison plot saved to png/roc_logistic_vs_gwlr.png")