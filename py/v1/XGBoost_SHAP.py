...
plt.tight_layout()
plt.savefig("png/shap_importance.png", dpi=150, bbox_inches='tight')
plt.close()
print("✓ png/shap_importance.png saved")
...
plt.tight_layout()
plt.savefig("png/shap_summary.png", dpi=150, bbox_inches='tight')
plt.close()
print("✓ png/shap_summary.png saved")
...
plt.suptitle("SHAP dependence plots — detect non-linear effects\n"
             ...
             fontsize=11, y=1.00)
plt.tight_layout()
plt.savefig("png/shap_dependence.png", dpi=150, bbox_inches='tight')
plt.close()
print("✓ png/shap_dependence.png saved")
...
ax.grid(alpha=0.3)
plt.tight_layout()
plt.savefig("png/roc_logistic_vs_xgboost.png", dpi=150, bbox_inches='tight')
plt.close()
print("✓ png/roc_logistic_vs_xgboost.png saved")
