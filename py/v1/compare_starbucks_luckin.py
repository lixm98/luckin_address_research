...
luckin = pd.read_csv("csv/logit_coefficients.csv", index_col=0)
starbucks = pd.read_csv("csv/starbucks_logit_coefficients.csv", index_col=0)
...
plt.tight_layout()
plt.savefig("png/luckin_vs_starbucks_coefs.png", dpi=150, bbox_inches='tight')
plt.close()
print(f"\n✓ Comparison chart saved to png/luckin_vs_starbucks_coefs.png")


# 8. Save the comparison table
comparison.to_csv("csv/luckin_vs_starbucks_comparison.csv", encoding='utf-8-sig')
print(f"✓ Comparison table saved to csv/luckin_vs_starbucks_comparison.csv")


# 9. Comparison of overall model performance
try:
    sb_summary = pd.read_csv("csv/starbucks_model_summary.csv")
