...
lk = pd.read_csv("csv/task1_features_excl50_seed42.csv")
sb = pd.read_csv("csv/task3_starbucks_features_excl50_seed42.csv")
...
out.to_csv("csv/task3_pooled_model.csv", encoding='utf-8-sig')
...
p1, s1 = fit_brand(pd.read_csv("csv/task1_features_excl50_seed42.csv"))
p0, s0 = fit_brand(pd.read_csv("csv/task3_starbucks_features_excl50_seed42.csv"))
...
wald.to_csv("csv/task3_wald_robustness.csv", encoding='utf-8-sig')
print("\n=== Wald robustness===")
