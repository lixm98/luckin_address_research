...
plt.tight_layout(); plt.savefig("png/shap_importance_excl50.png", dpi=150, bbox_inches='tight'); plt.close()

fig = plt.figure(figsize=(10, 6))
shap.summary_plot(shap_values, X, feature_names=FEATURES, show=False)
plt.tight_layout(); plt.savefig("png/shap_summary_excl50.png", dpi=150, bbox_inches='tight'); plt.close()
...
# plt.tight_layout(); plt.savefig("png/shap_dependence_excl50.png", dpi=150, bbox_inches='tight'); plt.close()
...
plt.tight_layout()
plt.savefig("png/selected_shap_dependence_excl50.png", dpi=150, bbox_inches='tight')
plt.close()
