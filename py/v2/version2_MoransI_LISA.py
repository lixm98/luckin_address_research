...
df.to_csv("csv/task4_lisa_results.csv", index=False, encoding="utf-8-sig")
...
plt.tight_layout()
plt.savefig("png/task4_lisa_map_fdr.png", dpi=150, bbox_inches='tight')
plt.close()
...
print("✓ csv/task4_moran_grid.csv / csv/task4_lisa_results.csv / png/task4_lisa_map_fdr.png")