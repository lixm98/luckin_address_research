...
if missing_cols:
    raise ValueError(f"residuals_excel50.csv Required columns are missing:{missing_cols}")
...
print("\n✓ Output:")
print("  - task4_moran_grid.csv")
print("  - task4_lisa_results.csv")
print("  - task4_lisa_map_fdr.png")